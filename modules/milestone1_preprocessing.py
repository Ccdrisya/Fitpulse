...
def load_data(filepath: str) -> pd.DataFrame:
    ...
    if ext == ".csv":
        df = pd.read_csv(os.path.join("data", "fitness_data_raw.csv"))
    elif ext == ".json":
...
# MAIN
# ─────────────────────────────────────────────
# In run_milestone1(), change this line:
def run_milestone1(csv_path: str = r"C:\Users\drisy\Desktop\infosys\py\fitness_data_raw.csv") -> pd.DataFrame:    
    print("\n" + "=" * 55)
